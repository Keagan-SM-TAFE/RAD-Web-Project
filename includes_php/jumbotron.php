...
<div class="container col-xxl-8 px-4 py-5">
    ...
    <div class="col-lg-6">
        ...
        <p class="lead">An application designed to search a movie database and return the results in an HTML table form.
        the application uses PHP to search a MySQL database and return only the movies that match the search criteria.
