<?php
// include event class 
require_once 'includes_php\\phpActions\\newsletter.php';
...
$site_name = 'RAD Project'; 
$site_email = '30017653#tafe.wa.edu.au'; 
...
require_once "includes_php\\templates\\head.php";
require_once "includes_php\\templates\\navBar.php";
require_once "includes_php\\templates\\showcase.php";
?>
  <section class="showcase">
     <div class="container">
      <div class="text-center">
        ...
        <hr>
        <p>
          Having trouble? <a href="mailto:email@email.com">Contact us</a>
        </p>
        <p class="lead">
  ...
  <br><br><br><br><br><br>
<?php 
require_once "includes_php\\templates\\genericFooter.php";
;
}
