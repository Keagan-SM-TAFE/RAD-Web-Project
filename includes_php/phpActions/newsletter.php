...
require_once "includes_php\\databaseConnectionConfig\\dbMovieConnection.php";
// Newsletter class
class Newsletter 
{
    protected $db;
    ...
    public function create() {
		try {
    		$sql = 'INSERT INTO moviedatabase_newsletter (name, email, verification_code, is_verified, created_date, status)  VALUES (:name, :email, :verification_code, :is_verified, :created_date, :status)';
    		$data = [
			    'name' => $this->_name,
                'email' => $this->_email,
