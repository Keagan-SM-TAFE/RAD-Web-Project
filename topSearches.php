...
$gridData = array();
$maxYValue = 0;
$searchQuery = "SELECT searchNum as rate, Title as title FROM `moviedatabase_movies` ORDER BY `rate` DESC LIMIT 10";
...
?>
  <div class="chart-bar" aria-label="Top 10 searched movies results image">
    <canvas id="myBarChart" aria-label="Top 10 searched movies results image" role="img"><p>Top 10 searched movies results image</p></canvas>
<?php
